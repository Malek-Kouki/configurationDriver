...
public class ConfigurationWebDriverManager {
	...
	@BeforeMethod
	public void setup() {
		//WebDriverManager va verifer la version de chrome de façon automatique
		//telecharger le bon chromedriver et il va configurer le chemen automatiquement du chromedriver
